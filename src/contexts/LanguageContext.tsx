...
const translations = {
  fa: {
    ...
    footer: { brand: "نئوهوش", tagline: "پلی به دنیای هوش مصنوعی", quickLinks: "لینک‌های سریع", homepage: "صفحه اصلی", contact: "تماس با ما", learnMore: "بیشتر بدانید", social: "شبکه‌های اجتماعی", copyright: "تمام حقوق محفوظ است" },
    chat: {
      title: "نئوهوش",
  ...
  en: {
    ...
    footer: { brand: "NeoHoosh", tagline: "A bridge to the world of AI", quickLinks: "Quick Links", homepage: "Homepage", contact: "Contact Us", learnMore: "Learn More", social: "Social", copyright: "All rights reserved" },
    chat: {
      title: "NeoHoosh",
