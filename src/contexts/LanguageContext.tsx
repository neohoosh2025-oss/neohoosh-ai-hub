...
const translations = {
  fa: {
    ...
    logout: "خروج",
    login: "ورود",
    profile: { title: "پروفایل کاربری", description: "اطلاعات حساب کاربری خود را مدیریت کنید", email: "ایمیل", emailNote: "ایمیل قابل تغییر نیست", displayName: "نام نمایشی", displayNamePlaceholder: "نام خود را وارد کنید", save: "ذخیره تغییرات", updateSuccess: "پروفایل با موفقیت به‌روز شد" },
    dashboard: { welcome: "خوش آمدید", subtitle: "نمای کلی فعالیت‌ها و آمار شما", savedArticles: "مقالات ذخیره شده", totalActivity: "کل فعالیت‌ها", memberSince: "عضویت از", recentlySaved: "اخیراً ذخیره شده", savedDesc: "مقالات ذخیره شده شما", noSaved: "هنوز مقاله‌ای ذخیره نکرده‌اید", recentActivity: "فعالیت‌های اخیر", activityDesc: "آخرین فعالیت‌های شما", noActivity: "هنوز فعالیتی ثبت نشده", viewedArticle: "مقاله را مشاهده کرد", savedArticle: "مقاله را ذخیره کرد" },
    ...
    aboutPage: { header: "درباره", headerBrand: "نئوهوش", headerDesc: "پلی به دنیای هوش مصنوعی", missionTitle: "ماموریت ما", missionDesc: "نئوهوش با هدف ساده‌سازی و دموکراتیزه‌کردن دانش هوش مصنوعی تاسیس شده است", visionTitle: "چشم‌انداز ما", visionDesc: "تبدیل شدن به منبع اصلی و قابل اعتماد برای یادگیری و استفاده از هوش مصنوعی در ایران و منطقه", teamTitle: "تیم ما", teamDesc: "تیم نئوهوش متشکل از متخصصان علاقه‌مند به هوش مصنوعی است", founderName: "محمدرضا تقی معز", founderRole: "بنیانگذار و مدیر عامل", valueSimplicity: "سادگی", valueSimplicityDesc: "آموزش به زبان ساده و قابل فهم", valueInnovation: "نوآوری", valueInnovationDesc: "به‌روز ماندن با آخرین پیشرفت‌های هوش مصنوعی", valueQuality: "کیفیت", valueQualityDesc: "ارائه محتوای دقیق و معتبر" },
    ...
    chat: { pleaseLogin: "لطفا ابتدا وارد شوید", selectModel: "یک مدل انتخاب کنید", typeMessage: "پیام خود را بنویسید", newConversation: "گفتگوی جدید", backToModels: "بازگشت به مدل‌ها" }
  },
  en: {
    ...
    profile: { title: "User Profile", description: "Manage your account information", email: "Email", emailNote: "Email cannot be changed", displayName: "Display Name", displayNamePlaceholder: "Enter your name", save: "Save Changes", updateSuccess: "Profile updated successfully" },
    dashboard: { welcome: "Welcome", subtitle: "Overview of your activities and statistics", savedArticles: "Saved Articles", totalActivity: "Total Activities", memberSince: "Member Since", recentlySaved: "Recently Saved", savedDesc: "Your saved articles", noSaved: "You haven't saved any articles yet", recentActivity: "Recent Activity", activityDesc: "Your latest activities", noActivity: "No activity recorded yet", viewedArticle: "Viewed article", savedArticle: "Saved article" },
    ...
    chat: { pleaseLogin: "Please login first", selectModel: "Select a model", typeMessage: "Type your message", newConversation: "New Conversation", backToModels: "Back to Models" }
  },
  ar: {
    ...
    profile: { title: "الملف الشخصي", description: "إدارة معلومات حسابك", email: "البريد الإلكتروني", emailNote: "لا يمكن تغيير البريد الإلكتروني", displayName: "الاسم المعروض", displayNamePlaceholder: "أدخل اسمك", save: "حفظ التغييرات", updateSuccess: "تم تحديث الملف الشخصي بنجاح" },
    dashboard: { welcome: "مرحباً", subtitle: "نظرة عامة على أنشطتك وإحصائياتك", savedArticles: "المقالات المحفوظة", totalActivity: "إجمالي الأنشطة", memberSince: "عضو منذ", recentlySaved: "المحفوظ مؤخراً", savedDesc: "مقالاتك المحفوظة", noSaved: "لم تحفظ أي مقالات بعد", recentActivity: "النشاط الأخير", activityDesc: "أحدث أنشطتك", noActivity: "لا يوجد نشاط حتى الآن", viewedArticle: "شاهد مقالاً", savedArticle: "حفظ مقالاً" },
    ...
    chat: { pleaseLogin: "يرجى تسجيل الدخول أولاً", selectModel: "اختر نموذجاً", typeMessage: "اكتب رسالتك", newConversation: "محادثة جديدة", backToModels: "العودة إلى النماذج" }
  }
} as const;
