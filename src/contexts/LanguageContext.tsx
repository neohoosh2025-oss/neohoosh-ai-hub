...
const translations = {
  fa: {
    ...
    logout: "خروج",
    login: "ورود",
    profile: { title: "پروفایل کاربری", description: "اطلاعات حساب کاربری خود را مدیریت کنید", email: "ایمیل", emailNote: "ایمیل قابل تغییر نیست", displayName: "نام نمایشی", displayNamePlaceholder: "نام خود را وارد کنید", save: "ذخیره تغییرات", updateSuccess: "پروفایل با موفقیت به‌روز شد", memoryManagement: "مدیریت حافظه چت‌بات", memoryDescription: "اطلاعات ذخیره شده در چت‌بات را مشاهده کنید", userDashboard: "داشبورد کاربری", dashboardDescription: "مشاهده فعالیت‌ها و مقالات ذخیره شده", updateProfile: "به‌روزرسانی پروفایل", updating: "در حال به‌روزرسانی...", signOut: "خروج از حساب", quickAccess: "دسترسی سریع" },
