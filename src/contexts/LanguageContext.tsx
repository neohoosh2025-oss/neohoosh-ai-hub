...
const translations = {
  ...
  en: {
    ...
    dashboard: { welcome: "Welcome", subtitle: "Overview of your activities and statistics", savedArticles: "Saved Articles", totalActivity: "Total Activities", memberSince: "Member Since", recentlySaved: "Recently Saved", savedDesc: "Your saved articles", noSaved: "You haven't saved any articles yet", recentActivity: "Recent Activity", activityDesc: "Your latest activities", noActivity: "No activity recorded yet", viewedArticle: "Viewed article", savedArticle: "Saved article", savedOn: "Saved on" },
